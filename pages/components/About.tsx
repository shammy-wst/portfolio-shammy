    ...
    <div id='about' className='w-full md:h-screen p-2 flex items-center py-16'>
        <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
            <div className='col-span-2'>
                ...
                <p className='py-4 text-white'>Not you're usual developper i guess</p>

                <p className='py-4 text-white'>I have spent my entire chilhood finding myself in new technologies. I've always had a knack for technology and woring with computers, i've touched mr first PC at 8 years old. In 2016 i've started working with HTML & CSS bases to create little websites to make laugh my friends. What I thought was just a few small jokes turned into a love for programming. </p>
                ...
                <p className='py-4 text-white'>
                    ...
                    <Link href='/#projects' className='tracking-widest font-bold text-[#26E8A0] py-2 underline cursor-pointer'>
