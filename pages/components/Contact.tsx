...
{/* Left Side */}
            <div className='col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-[#363636] rounded-xl p-4'>
...
{/* Right Side */}
<div className='col-span-3 w-full h-auto shadow-xl shadow-[#363636] rounded-xl lg:p-4'>
    <div className='p-4'>
        <form>
            ...
            <div className='flex flex-col py-2'>
                ...
                <input className="border-2 rounded-lg p-3 flex border-[#363636]" type='email'/>
            </div>
            <div className='flex flex-col py-2'>
