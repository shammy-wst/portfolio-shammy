    ...
    <div className="flex flex-col m-auto sm:justify-center md:justify-between w-full">
      ...
      <div id="Project2">
        ...
        <div className="flex flex-col gap-2 p-4 m-0 text-lg">
          ...
          <div className="flex justify-between p-0 gap-2">
            <p className="flex w-4/5">{description="I've overhauled Greenly's product page completely using Figma. The redesigned prototype is a sleek and user-friendly upgrade, promising a more engaging and efficient browsing experience for our customers. This revamp underscores our commitment to cutting-edge design and technology in e-commerce."}</p>
            <p className="flex">{date="2023"}</p>
          </div>
      ...
      <div id="Project3">
        ...
        <div className="flex flex-col gap-2 p-4 m-0 text-lg">
          ...
          <div className="flex justify-between p-0 gap-2">
            <p className="flex w-4/5">{description="I've been working on a new project to help companies comply with the GDPR. I've completely redesigned and integrated Mission RGPD's website using native HTML and CSS, resulting in a polished and efficient user experience."}</p>
            <p className="flex">{date="2023"}</p>
          </div>
          <div className="flex flex-row gap-2">
      ...
      <div id="Project4">
        ...
        <div className="flex flex-col gap-2 p-4 m-0 text-lg">
          ...
          <div className="flex justify-between p-0 gap-2">
            <p className="flex w-4/5">{description="I've meticulously crafted Dashblade, a cryptocurrency mobile app, from scratch using Figma. Through a comprehensive prototyping process, I've focused on reliability and speed to ensure a seamless user experience."}</p>
