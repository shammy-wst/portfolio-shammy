...
const Header = () => {
  return (
            <header className='flex bg-black text-white flex-row align-middle justify-between border-2 border-white p-6 w-full m-0 '>
                <figure className='flex flex-col gap-2 justify-center align-middle p-0'>
