...
const Header = () => {
  return (
    <div className='fixed top-0 left-0 right-0 z-50 bg-white w-full flex flex-row justify-between p-5'>
        ...
        <div className='flex p-0 m-0 gap-10 uppercase'>
            <a href='#' className='font-bold text-center text-black'>Home</a>
            <a href='#' className='font-bold text-center text-black'>About</a>
            <a href='https://www.linkedin.com/in/aichammmadi/' className='font-bold text-center text-black'>Contact</a>
        </div>
    </div>
  )
}
