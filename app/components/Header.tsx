...
const Header = () => {
  return (
            <header className='sm:justify-center md:justify-between flex bg-black text-white flex-row align-middle justify-between border-2 border-white p-6 w-full m-0 '>
